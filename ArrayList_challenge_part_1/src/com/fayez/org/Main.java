...
// CREATE A PROGRAM THAT IMPLEMENTS  A SIMPLE MOBILE PHONES WITH THE FOLLOWINGS  CAPABILITIES
// ABLE TO STORE ,MODIFY, REMOVE  AND QUERY CONTACT NAMES
//YOU WILL WANT TO CREATE A SEPARATE  CLASS FOR CONTACTS(NAME AND PHONE NUMBER)
//CREATE A MASTER CLASS(MobilePhone) THAT HOLDS THE ARRAYLISTS FOR CONTACTS
//THE MobilePhone HAS THE FUNCTIONALITY LISTED ABOVE
//ADD  MENU FOR OPTIONS THAT ARE  AVAILABLE
//options:--> QUIT,PRINT EXISTING CONTACT LIST,,ADD NEW CONTACT,, UPDATE EXISTING CONTACT LIST ,,REMOVE CONTACT LIST ,, SEARCH/FIND  CONTACT
//WHEN ADDING OR UPDATING BE SURE CHECK IF  THE CONTACT  ALREADY EXISTS(use name)
//BE SURE NOT TO EXPRESS INNER  WORKING OF ARRAYLIST TO MobilePhone[{(e.g.  no  ints ,no get(i),etc)}]
//MobilePhone should do everything with the contact class only
